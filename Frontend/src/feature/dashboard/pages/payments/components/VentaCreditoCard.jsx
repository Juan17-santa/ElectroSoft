...
export default function VentaCreditoCard({ venta, onDetalle, onAbonar }) {
    ...
    return (
        <div className={`bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-5 flex items-center gap-6 border border-transparent ${
            isVencida    ? "border-l-4 border-l-red-400"    :
                ...
                <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                        className={`h-full rounded-full transition-all duration-500 ${
                            isVencida ? "bg-red-400" : "bg-green-400"
                        }`}
