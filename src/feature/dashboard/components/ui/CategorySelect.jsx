...
export default function CategorySelect({
    ...
    const filteredOptions = options.filter(option =>
        option.nombre && option.nombre.toLowerCase().includes(searchTerm.toLowerCase())
    );
        ...
        <div ref={dropdownRef} className={`relative ${width}`}>
            <div className="flex flex-col gap-3">
                ...
                <button
                    ...
                    className={`w-full bg-gray-200 rounded-xl px-4 py-3 text-sm shadow-md border-2 flex justify-between items-center cursor-pointer hover:bg-gray-300 transition focus:outline-none focus:ring-2 focus:ring-yellow-400 text-left ${
