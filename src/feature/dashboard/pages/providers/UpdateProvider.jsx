...
export default function UpdateProvider() {
    ...
    useEffect(() => {
        ...
        const data = localStorage.getItem("providerToEdit");
        ...
        <>
            <div className="bg-gray-100 p-6 rounded-2xl flex flex-col gap-6 shadow-inner">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        <p className="text-xl font-semibold mb-4">Editar proveedor <span className="text-yellow-400">de productos</span></p>
