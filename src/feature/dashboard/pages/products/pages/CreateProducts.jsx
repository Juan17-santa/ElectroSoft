    ...
    return (
        <div className="w-full h-full bg-gray-100 p-6 rounded-2xl flex flex-col gap-6 shadow-inner box-border overflow-y-auto">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="col-span-3 border-2 border-yellow-300 rounded-xl p-6 bg-gradient-to-b from-yellow-50 to-transparent">
                    ...
                    <div className="grid grid-cols-3 gap-6 mb-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`bg-gray-200 rounded-xl px-3 py-2.5 text-sm shadow-md w-full border-2 ${
                                        characteristicErrors.nombre ? 'border-red-500' : 'border-transparent'
                                    ...
                                    <div className="absolute top-full left-0 w-full bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-auto z-10 mt-1">
                                        ...
                                        {modalForm.nombre.trim() && !characteristicOptions.some(o => o.nombre.toLowerCase() === modalForm.nombre.toLowerCase()) && (
                                            <div className="px-4 py-2.5 border-t bg-yellow-50 flex justify-between items-center">
                                                ...
                                                <button type="button" disabled={!!characteristicErrors.nombre} onClick={() => addCharacteristicOption(modalForm.nombre)} className={`text-sm font-medium ${
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="Seleccionar o crear"
                                    className={`bg-gray-200 rounded-xl px-3 py-2.5 text-sm shadow-md w-full border-2 ${
                                        characteristicErrors.medida ? 'border-red-500' : 'border-transparent'
                                    } focus:border-yellow-400 focus:outline-none`}
                                />
                                {measDropdownOpen && (
                                    <div className="absolute top-full left-0 w-full bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-auto z-10 mt-1">
                                        ...
                                        {modalForm.medida.trim() && !measureOptions.some(o => o.nombre.toLowerCase() === modalForm.medida.toLowerCase()) && (
                                            <div className="px-4 py-2.5 border-t bg-yellow-50 flex justify-between items-center">
                                                ...
                                                <button type="button" disabled={!!characteristicErrors.medida} onClick={() => addMeasureOption(modalForm.medida)} className={`text-sm font-medium ${
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input
                                ...
                                className={`bg-gray-200 rounded-xl px-3 py-2.5 text-sm shadow-md w-full border-2 ${
                                    characteristicErrors.valor ? 'border-red-500' : 'border-transparent'
                                } focus:border-yellow-400 focus:outline-none`}
                            />
